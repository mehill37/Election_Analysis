...
file_to_load = os.path.join("C:/Users/Mary/Data Visualizations BC/Election_Analysis/election_results.csv")
# Assign a variable to save the file to a path.
file_to_save = os.path.join("C:/Users/Mary/Data Visualizations BC/Election_Analysis/election_analysis.txt")
...
#Track the largest turnout per county
winning_county = ""
county_wins = 0
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        if county_name not in county_options:
            ...
            # And begin tracking the county's voter count.
...
with open(file_to_save, "w") as txt_file:
    ...
    # Print each counties vote count and percentage to the terminal.
